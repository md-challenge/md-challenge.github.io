...
class CommentData {
  ...
  static const _linkFontSize = 15.0;
  ...
  static RichText createComment() {
    ...
    return RichText(
        text: TextSpan(children: [
          TextSpan(text: commentText1, style: commentStyle),
          TextSpan(
              text: commentText2,
              style: linkStyle,
          ...
          TextSpan(text: commentText3, style: commentStyle),
          TextSpan(
              text: commentText4,
              style: linkStyle,
              recognizer: TapGestureRecognizer()
          ...
          TextSpan(text: commentText5, style: commentStyle),
        ]),
